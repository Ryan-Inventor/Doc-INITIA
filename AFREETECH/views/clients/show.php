    ...
    <div class="flex-1 overflow-x-hidden overflow-y-auto">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                <div>
                    <h3 class="text-2xl sm:text-3xl font-semibold text-slate-900 tracking-tight">Détails du client</h3>
                    <p class="text-sm text-slate-500 mt-1">
                        Informations complètes pour le client sélectionné.
                    </p>
                </div>
                <div class="flex flex-wrap gap-2">
                    <a href="<?php echo url('clients/edit/' . $this->client->id); ?>" class="inline-flex items-center justify-center rounded-xl bg-indigo-600 px-4 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-1">
                        Modifier
                    </a>
                    <a href="<?php echo url('clients'); ?>" class="inline-flex items-center justify-center rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-sm font-medium text-slate-700 hover:bg-slate-50">
                        Retour
                    </a>
                </div>
            </div>
            ...
            <div class="bg-white/80 backdrop-blur rounded-2xl border border-slate-100 shadow-sm">
                <div class="px-6 py-4 border-b border-slate-100">
                    ...
                    <p class="mt-1 text-sm text-slate-500">
                        Coordonnées et informations d'identité du client.
                    </p>
                </div>
                <div>
                    <dl class="divide-y divide-slate-100">
                        ...
                        <div class="bg-slate-50/60 px-6 py-4 grid grid-cols-1 sm:grid-cols-3 gap-2 sm:gap-4">
                            ...
                            <dd class="text-sm text-slate-900 sm:col-span-2">
                                <?php echo $this->client->telephone; ?>
                            </dd>
                        </div>
                        <div class="bg-white px-6 py-4 grid grid-cols-1 sm:grid-cols-3 gap-2 sm:gap-4">
                            <dt class="text-xs font-medium text-slate-500 uppercase tracking-wide">
                            ...
                            <dd class="text-sm text-slate-900 sm:col-span-2 space-y-0.5">
                                <div><?php echo $this->client->adresse; ?></div>
                                <div class="text-slate-600"><?php echo $this->client->ville; ?></div>
                            </dd>
                        </div>
                        <div class="bg-slate-50/60 px-6 py-4 grid grid-cols-1 sm:grid-cols-3 gap-2 sm:gap-4">
                            <dt class="text-xs font-medium text-slate-500 uppercase tracking-wide">
                            ...
                            <dd class="text-sm text-slate-900 sm:col-span-2">
                                <?php echo $this->client->date_naissance; ?>
                            </dd>
                        </div>
                        <div class="bg-white px-6 py-4 grid grid-cols-1 sm:grid-cols-3 gap-2 sm:gap-4">
                            <dt class="text-xs font-medium text-slate-500 uppercase tracking-wide">
                            ...
                            <dd class="text-sm text-slate-900 sm:col-span-2">
                                <?php echo $this->client->numero_cni; ?>
                            </dd>
                        </div>
                        <div class="bg-slate-50/60 px-6 py-4 grid grid-cols-1 sm:grid-cols-3 gap-2 sm:gap-4">
                            <dt class="text-xs font-medium text-slate-500 uppercase tracking-wide">
                            ...
                            <dd class="text-sm text-slate-900 sm:col-span-2">
                                <span class="inline-flex items-center rounded-full bg-emerald-50 px-2.5 py-1 text-xs font-medium text-emerald-700">
                                    <?php echo $this->client->succursale_rattachee; ?>
                                </span>
                            </dd>
                        </div>
                        <div class="bg-white px-6 py-4 grid grid-cols-1 sm:grid-cols-3 gap-2 sm:gap-4">
                            ...
                            <dd class="text-sm text-slate-900 sm:col-span-2">
                                <?php echo $this->client->date_inscription; ?>
                            </dd>
                        </div>
                    </dl>
                </div>
