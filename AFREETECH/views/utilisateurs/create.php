...
<div class="min-h-screen flex bg-transparent">
    ...
    <div class="flex-1 overflow-x-hidden overflow-y-auto">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
            ...
            <div>
                <h3 class="text-2xl sm:text-3xl font-semibold text-slate-900 tracking-tight">Nouvel utilisateur</h3>
                <p class="text-sm text-slate-500 mt-1">
                    Créez un compte administrateur ou gestionnaire pour la plateforme.
                </p>
            </div>

            <div class="bg-white/80 backdrop-blur rounded-2xl border border-slate-100 shadow-sm p-6 sm:p-8">
                <form action="<?php echo url('utilisateurs/create'); ?>" method="POST" class="space-y-6">
                    <?php if(isset($error)): ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input class="block w-full rounded-xl border border-slate-200 px-3 py-2.5 text-sm text-slate-900 shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-1 outline-none" id="email" name="email" type="email" required>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-slate-700 mb-1.5" for="password">Mot de passe</label>
                            <input class="block w-full rounded-xl border border-slate-200 px-3 py-2.5 text-sm text-slate-900 shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-1 outline-none" id="password" name="password" type="password" required>
                        </div>
                        <div>
